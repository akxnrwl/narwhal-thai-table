...
export const metadata: Metadata = {
  ...
  description: "A Thai family table on Beach Boulevard, Huntington Beach. Every dish hand-prepared by Chef Namfon, of MasterChef Thailand Season 1.",
  ...
  openGraph: {
    ...
    description: 'A Thai family table on Beach Boulevard. Every dish by Chef Namfon, of MasterChef Thailand Season 1.',
